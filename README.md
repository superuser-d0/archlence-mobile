...
Writing has started: accounts, transactions, holdings and savings goals can
all be entered. A budget line, a card-debt payment and subscription edits each
still have a tested service call and no form to call it from. Live price fetching is an open decision, so holdings are shown at what
