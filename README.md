...
Writing has started: accounts, transactions, holdings, savings goals and
budget lines can all be entered. A card-debt payment and subscription edits
each still have a tested service call and no form to call it from. Live price fetching is an open decision, so holdings are shown at what
